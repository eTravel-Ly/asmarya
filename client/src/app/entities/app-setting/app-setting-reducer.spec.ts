...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_APPSETTING_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_APPSETTING actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_APPSETTING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_APPSETTING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_APPSETTING actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_APPSETTING actions', async () => {
      const arg = 42666;
