...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COURSEVIDEO_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_COURSEVIDEO actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_COURSEVIDEO actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_COURSEVIDEO actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_COURSEVIDEO actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_COURSEVIDEO actions', async () => {
      const arg = 42666;
