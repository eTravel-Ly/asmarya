        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedBlobField label="ملف صورة الغلاف" id="book-coverImageFile" name="coverImageFile" accept="*/*" />
              {/*<ValidatedField label="Cover Image Url" id="book-coverImageUrl" name="coverImageUrl" data-cy="coverImageUrl" type="text" />*/}
              <ValidatedBlobField label="ملف الكتاب" id="book-bookFile" name="bookFile" data-cy="bookFile" isImage accept="image/*" />
