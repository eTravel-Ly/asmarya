...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ACTIVATION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ACTIVATION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ACTIVATION actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_ACTIVATION actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_ACTIVATION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ACTIVATION actions', async () => {
      const arg = 42666;
