...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './cart-item.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CARTITEM actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CARTITEM actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_CARTITEM actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_CARTITEM actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CARTITEM actions', async () => {
      const arg = 42666;
