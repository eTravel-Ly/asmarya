...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PAYMENTMETHOD_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PAYMENTMETHOD actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PAYMENTMETHOD actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_PAYMENTMETHOD actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_PAYMENTMETHOD actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PAYMENTMETHOD actions', async () => {
      const arg = 42666;
