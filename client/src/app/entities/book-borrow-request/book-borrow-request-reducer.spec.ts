...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './book-borrow-request.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BOOKBORROWREQUEST_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BOOKBORROWREQUEST actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BOOKBORROWREQUEST actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_BOOKBORROWREQUEST actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_BOOKBORROWREQUEST actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BOOKBORROWREQUEST actions', async () => {
      const arg = 42666;
