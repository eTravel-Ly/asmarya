...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './slider.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SLIDER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SLIDER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SLIDER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_SLIDER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_SLIDER actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SLIDER actions', async () => {
      const arg = 42666;
