...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './sheikh.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SHEIKH_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SHEIKH actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SHEIKH actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_SHEIKH actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_SHEIKH actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SHEIKH actions', async () => {
      const arg = 42666;
