...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './learner.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LEARNER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_LEARNER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_LEARNER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_LEARNER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_LEARNER actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_LEARNER actions', async () => {
      const arg = 42666;
