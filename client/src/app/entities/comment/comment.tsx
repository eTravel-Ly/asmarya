          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('likesCount')}>
                  Likes Count <FontAwesomeIcon icon={getSortIconByFieldName('likesCount')} />
                </th>
                <th className="hand" onClick={sort('dislikesCount')}>
                  Dislikes Count <FontAwesomeIcon icon={getSortIconByFieldName('dislikesCount')} />
                </th>
                <th>
            ...
            <tbody>
              {commentList.map((comment, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{comment.learner ? <Link to={`/learner/${comment.learner.id}`}>{comment.learner.firstName}</Link> : ''}</td>
                  <td>{comment.book ? <Link to={`/book/${comment.book.id}`}>{comment.book.title}</Link> : ''}</td>
                  <td>{comment.course ? <Link to={`/course/${comment.course.id}`}>{comment.course.title}</Link> : ''}</td>
