            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('name')}>
                  الاسم <FontAwesomeIcon icon={getSortIconByFieldName('name')} />
                </th>
                ...
                <th className="hand" onClick={sort('managerName')}>
                  اسم المدير <FontAwesomeIcon icon={getSortIconByFieldName('managerName')} />
                </th>
                <th className="hand" onClick={sort('workingHours')}>
                  ساعات العمل <FontAwesomeIcon icon={getSortIconByFieldName('workingHours')} />
                </th>
                <th className="hand" onClick={sort('numberOfStudents')}>
                  عدد الطلاب <FontAwesomeIcon icon={getSortIconByFieldName('numberOfStudents')} />
                </th>
                <th className="hand" onClick={sort('numberOfTeachers')}>
                  عدد المعلمين <FontAwesomeIcon icon={getSortIconByFieldName('numberOfTeachers')} />
                </th>
                <th className="hand" onClick={sort('establishmentDate')}>
                  تاريخ التأسيس <FontAwesomeIcon icon={getSortIconByFieldName('establishmentDate')} />
                </th>
            ...
            <tbody>
              {centerList.map((center, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{center.numberOfStudents}</td>
                  <td>{center.numberOfTeachers}</td>
                  <td>
                    {center.establishmentDate ? (
                      <TextFormat type="date" value={center.establishmentDate} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>{center.programsOffered}</td>
                  <td>{center.description}</td>
                  <td className="text-end">
                    <div className="btn-group flex-btn-group-container">
                      <Button tag={Link} to={`/center/${center.id}`} size="sm" data-cy="entityDetailsButton">
