...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './center.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CENTER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CENTER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CENTER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_CENTER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_CENTER actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CENTER actions', async () => {
      const arg = 42666;
