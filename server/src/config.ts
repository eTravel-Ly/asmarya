...
export class Config {
  debugLogging = 'debug';
  'server.port' = '8080';
  'jhipster.clientApp.name' = 'asmarya';
  ...
  'jhipster.mail.from' = 'asmarya@localhost';
  'jhipster.swagger.default-include-pattern' = '/api/.*';
  'jhipster.swagger.title' = 'asmarya API';
  'jhipster.swagger.description' = 'asmarya API documentation';
  ...
  'eureka.instance.appname' = 'asmarya';
  'eureka.instance.instanceId' = 'asmarya:${random.value}';
...
const envYamlConfigPath = path.join(__dirname, 'config', `application-prod.yml`);
